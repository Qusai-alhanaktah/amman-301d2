...
function displayPics(){
  ...
  // there is no hosted happend when we use le insted of var, if we console some thing before we difined it useing var will give "undifined" but by using let will give me "error"
